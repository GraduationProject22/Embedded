...
void HAL_IMU_Init(I2C_HandleTypeDef *I2Cx)
{
	...
	/*Defining the sample rate to be the same as gyroscope sample rate (prescaler = 0)*/
	data_write =	IMU_SAMPLE_RATE_PRESCALER;
	HAL_I2C_Mem_Write(I2Cx, IMU_ADDR, SMPLRT_DIV, I2C_MEMADD_SIZE_8BIT, &data_write, 1 ,i2c_timeout);
